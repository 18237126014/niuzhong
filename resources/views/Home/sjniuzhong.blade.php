...
<body>
    ...
    <div class="welcome"><p><u>Loading . . .</u></p>
    </div>
        ...
        <div class="swiper-container items">
           <div class="swiper-wrapper">
                 <div class="swiper-slide">
                    ...
                    <img src="/img/home/images/index.jpg" alt="实战案例" />
                    <p>实战案例<br/><strong>牛众网实战案例</strong><br />一站式服务</p></a>                  </div>
<div class="swiper-slide">
                    <a href="http://ww.chuangdc.cn/admin" target="_blank">
                    <img src="/img/home/images/houtai.jpg" alt="后台参考" />
                    <p>帐号：open 密码：123456<br /><strong>金融后台数据参考</strong><br />期货、外汇、大宗金融产品</p></a>                  </div>
<div class="swiper-slide">
                    <a href="#" target="_blank">
                    <img src="/img/home/images/waihui.jpg" alt="外汇" border="0" />
          <p>官方注册<br /><strong>外汇官网推广</strong><br />让用户自助注册开户到后台</p></a>                  </div>
           </div>
        </div>
      </div>
    </section>
   ...
   <!--  <section class="clients">
    ...
    <section class="quality">
      ...
      <div class="caption">
        ...
        <a href="#" class="lookall" target="_blank">查看更多详情</a>      </div>
    </section>
    ...
    <section class="contact">
      <div class="box">
          <div class="above">
              <div class="wechat"><img src="/img/home/images/wechat_code.jpg" alt="扫描关注牛众微信公众账号" /></div>
                <div class="left">
    ...
    <section class="marketing" style='display:none;'>
      <div class="box">
        <div class="caption">
...
<ul class="icons">
          <li class="up"><i></i></li>
            <li class="im">
              <i></i><p>在线客服<br />帮助解答，请点我<a href="#" target="_blank">在线咨询</a></p>
            </li>
        <li class="im">
              <i></i><p>在线客服<br />帮助解答，请点我<a href="#" target="_blank">在线咨询</a></p>
          </li>
